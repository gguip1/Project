...
public class HomeFragment extends Fragment implements View.OnClickListener, BeaconConsumer{
    ...
    /** MainActivity에서 받아온 timetable_data **/
    String input_data;
    public HomeFragment() {
...
//        Log.d("checkTime_Debug", String.valueOf(checkTime));
        ...
        if(input_data.equals(" \"fail:3\"")){
            ...
            /** 현재 수업 **/
            CurrentClass cc = new CurrentClass(checkTime, first, second, third, fourth, fifth, sixth, seventh, eighth, ninth, tenth);
            period = cc.getPeriod();
            switch (dayWeek){
                case 2:
...
//                    beaconList.clear();
    ...
    public void onClick(View view) {
        ...
        Log.d("debug", user_ID + " : " + String.valueOf(week_of_year - 34) + " : " +  String.valueOf(period)  + " : " +  String.valueOf(hour_of_day));

        /** 주말에는 sClass가 0이어서 empty:3 발생 **/
        task.execute("http://" + IP_ADDRESS + "/attendance.php", user_ID, String.valueOf(week_of_year - 34), String.valueOf(period), String.valueOf(hour_of_day));
